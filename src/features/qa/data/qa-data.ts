...
export const QA_DATA: QaCategory[] = [
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "In step 2 (Vocabulary), type your words or phrases separated by dots — for example: 'boiled. scramble. meat. fried'. You can enter up to 15 items. Then click 'Provide translations and definitions' and the AI generates a Russian translation and up to 3 English synonyms for each item.",
      },
      {
